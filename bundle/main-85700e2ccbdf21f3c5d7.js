...
/******/ 		return __webpack_require__.p + "" + ({"0":"commons-lodash-lodash.js","1":"lodash"}[chunkId]||chunkId) + "-" + {"0":"b0a9db341a1dfd03a481","1":"c9fd23eef76aa4d97848"}[chunkId] + ".js"
/******/ 	}
/******/
...
/* harmony default export */ var content = (function () {
  console.log('7777');
  console.log("bbb");
});
...
function getComponent() {
  return Promise.all(/* import() | lodash */[__webpack_require__.e(0), __webpack_require__.e(1)]).then(__webpack_require__.t.bind(null, 96, 7)).then(({
    default: _
  }) => {
...
var root = document.getElementById("root"); // var header = document.createElement("div")
...
const aaa = [new promise_default.a(() => {}), new promise_default.a(() => {})];
var header = createSingleElement("div", "header");
var src_content = createSingleElement("div", "content");
var Image = createSingleElement("img", logo);
root.append(new header());
root.append(new src_content());
